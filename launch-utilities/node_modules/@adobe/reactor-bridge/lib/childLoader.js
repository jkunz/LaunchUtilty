...
if (!window.extensionBridge) {
  var childPath = '/extensionbridge/extensionbridge-child.js';
  ...
  ['openCodeEditor', 'openDataElementSelector', 'openRegexTester', 'register', 'setDebug'].forEach(function (methodName) {
